...
"""Launch Webots TurtleBot3 Burger driver in the ARAMS hospital challenge world."""
...
def generate_launch_description():
    ...
    # The WebotsLauncher runs the simulation from a temporary copy of the world,
    # so Webots cannot find the native controllers (e.g. the walking nurse's
    # "pedestrian" controller) relative to that copy. Expose this package as an
    # extra Webots project so its `controllers/` directory is resolved.
    extra_project_path = package_dir
    if 'WEBOTS_EXTRA_PROJECT_PATH' in os.environ and os.environ['WEBOTS_EXTRA_PROJECT_PATH']:
        extra_project_path = package_dir + os.pathsep + os.environ['WEBOTS_EXTRA_PROJECT_PATH']
    os.environ['WEBOTS_EXTRA_PROJECT_PATH'] = extra_project_path
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
            'world',
            default_value='arams_hospital_2.wbt',
